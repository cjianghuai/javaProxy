...
import static cn.netinnet.server.ProjectConstant_Client.*;
...
public class ClientCodeGenerator {
    ...
    private static final String PROJECT_PATH = System.getProperty("user.dir") + "/nin-shortitem";//项目在硬盘上的基础路径
    private static final String TEMPLATE_PATH = System.getProperty("user.dir") + "/nin-shortitem";//模板在硬盘上的基础路径
    private static final String TEMPLATE_FILE_PATH = TEMPLATE_PATH + "/src/test/java/resources/generator/template";//模板位置
...
//        }
    ...
    public static void genModelAndMapper(String tableName, String modelName) {
        ...
        sqlMapGeneratorConfiguration.setTargetPackage("mapper" +"/"+ MOUDLE);
