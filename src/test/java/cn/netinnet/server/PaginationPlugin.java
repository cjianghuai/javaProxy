...
public class PaginationPlugin extends PluginAdapter {
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        FullyQualifiedJavaType imp = new FullyQualifiedJavaType("cn.netinnet.common.dao.BaseDao");
    ...
    public String getColunNames(IntrospectedTable introspectedTable) {
        ...
        clounNames = clounNames.length() > 0 ? clounNames + "," : clounNames ;
    ...
    public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
        ...
        /* insertSelect */
        addInsertSelective(parentElement, document, introspectedTable);
        ...
        /*批量插入*/
        addBatchInsert(parentElement, document, introspectedTable);
        ...
        //根据传入参数删除
        addDeleteByParameter(parentElement, document, introspectedTable);

//        //根据主键Ids批量删除
//        addDeleteByIds(parentElement, document, introspectedTable);

//        //根据主键Ids批量逻辑删除
//        deleteLogicByIds(parentElement, document, introspectedTable);

        return super.sqlMapDocumentGenerated(document, introspectedTable);
    }

    private void addDeleteByParameter(XmlElement parentElement, Document document, IntrospectedTable introspectedTable){
        XmlElement delete = new XmlElement("delete");
        delete.addAttribute(new Attribute("id", "deleteByParameter"));
    ...
    private void addDeleteByIds(XmlElement parentElement, Document document, IntrospectedTable introspectedTable) {

        XmlElement delete = new XmlElement("delete");
        delete.addAttribute(new Attribute("id", "deleteByIds"));
    ...
    private void deleteLogicByIds(XmlElement parentElement, Document document, IntrospectedTable introspectedTable){
        XmlElement update = new XmlElement("update");
        update.addAttribute(new Attribute("id", "deleteLogicByIds"));
        update.addAttribute(new Attribute("parameterType", "java.util.List"));

        update.addElement(new TextElement(" update "+ introspectedTable.getFullyQualifiedTableNameAtRuntime() + " set del = 1 , modify_user_code = #{modifyUserCode}"));
        String prikey = MyBatis3FormattingUtilities.getEscapedColumnName(introspectedTable.getPrimaryKeyColumns().get(0)) ;
        TextElement where  = new TextElement("where  " + prikey + " in ");
        XmlElement foreach = new XmlElement("foreach ");
        foreach.addAttribute(new Attribute("open ", "("));
    ...
    public void addInsertSelective(XmlElement parentElement, Document document, IntrospectedTable introspectedTable) {
...
//                    answer.addElement(getSelectKey(introspectedColumn, gk));
    ...
    public void addBatchInsert(XmlElement parentElement, Document document, IntrospectedTable introspectedTable) {
        XmlElement answer = new XmlElement("insert"); //$NON-NLS-1$
